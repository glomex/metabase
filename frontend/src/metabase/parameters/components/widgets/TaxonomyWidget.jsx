...
export default class TaxonomyWidget extends Component<*, Props, State> {
  props: Props;
  state: State;
  ...
  static format(value, field) {
    ...
    if (value.length > 1) {
      ...
      return <RemappedValue hideID value={value[0]} column={field} />;
    }
  }
  ...
  render() {
    ...
    if (!isFocused) {
      return (
        ...
        >
          {savedValue.length > 0 ? (
            TaxonomyWidget.format(savedValue, field)
          ) : (
